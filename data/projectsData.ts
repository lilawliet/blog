...
export const projectsData: PROJECT[] = [
  ...
  },
  {
    ...
    highlight: true,
    description:
      '基于北京万象生鲜系统二次开发，为珠海粤华搭建的线上销售平台，包含公园管养、爱尚卉、农科教育和农科优选模块',
    company: '珠海鲜美科技',
    resonsibility:
      '独立开发，各模块功能调试配置，项目多个版本业务功能迭代工作, 小程序嵌套的（公园管养/地图/推文）模块外部网站建设工作',
    tags: ['uni-app', 'vue3'],
    startTime: '2023-12',
    endTime: '2024-03',
  ...
  },
  {
    id: 'yuehua_home',
    name: '粤华园林官网',
    link: 'https://yhscape.zhnk.com.cn/',
    highlight: true,
    description:
  ...
  },
  {
    ...
    endTime: '2023-04',
    images: [
      '/static/bessage/gif/1.gif',
      '/static/bessage/gif/2.gif',
      '/static/bessage/gif/3.gif',
      '/static/bessage/gif/4.gif',
      '/static/bessage/gif/5.gif',
      '/static/bessage/gif/6.gif',
      '/static/bessage/gif/7.gif',
      '/static/bessage/gif/8.gif',
      '/static/bessage/gif/9.gif',
      '/static/bessage/gif/10.gif',
      '/static/bessage/gif/11.gif',
      '/static/bessage/1.png',
      '/static/bessage/2.png',
      '/static/bessage/3.png',
      '/static/bessage/4.png',
      '/static/bessage/5.png',
      '/static/bessage/6.png',
      '/static/bessage/7.png',
      '/static/bessage/8.png',
      '/static/bessage/9.png',
      '/static/bessage/10.png',
      '/static/bessage/11.png',
      '/static/bessage/12.png',
      '/static/bessage/13.png',
      '/static/bessage/14.png',
  ...
  },
  {
    ...
    endTime: '2022-11',
    images: [
      '/static/football-client/1.png',
      '/static/football-client/2.png',
      '/static/football-client/3.png',
      '/static/football-client/4.png',
      '/static/football-client/5.png',
      '/static/football-client/6.png',
      '/static/football-client/7.png',
      '/static/football-client/8.png',
      '/static/football-client/9.png',
      '/static/football-client/10.png',
      '/static/football-client/11.png',
      '/static/football-client/12.png',
      '/static/football-client/13.png',
  ...
  },
  {
    ...
    endTime: '2022-06',
    images: [
      '/static/paragon-extension/1.png',
      '/static/paragon-extension/2.png',
      '/static/paragon-extension/3.png',
      '/static/paragon-extension/5.png',
      '/static/paragon-extension/6.png',
      '/static/paragon-extension/7.png',
      '/static/paragon-extension/8.png',
      '/static/paragon-extension/9.png',
